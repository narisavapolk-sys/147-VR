import bpy, os, math
src=r'C:\Users\mongo\UnityProjects\147 VR\SNOOKER   VR pool table\Blender\147VR_Table_WPBSA_Visual_Clean_v002.blend'
out=r'C:\Users\mongo\UnityProjects\147 VR\Assets\AAA\ImportedSnooker\147VR_Table_WPBSA_Visual_Clean_v002.fbx'
...
for me in bpy.data.meshes:
    for uv_layer in me.uv_layers:
        for uv in uv_layer.data:
            if not (math.isfinite(uv.uv.x) and math.isfinite(uv.uv.y)): uv.uv=(0.0,0.0)
...
print('EXPORTED',out)
print('MESH_COUNT',sum(1 for o in bpy.context.scene.objects if o.type=='MESH'))
print('BALL_COUNT',sum(1 for o in bpy.context.scene.objects if o.get('asset_role')=='SNOOKER_BALL'))

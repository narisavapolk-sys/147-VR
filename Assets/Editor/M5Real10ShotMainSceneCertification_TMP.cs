...
[InitializeOnLoad]
public static class M5Real10ShotMainSceneCertification_TMP
{
    ...
    private const string SessionActiveKey = "M5_REAL10_ACTIVE";
    private const string SessionFiredKey = "M5_REAL10_FIRED";
    private const string SessionResolvedKey = "M5_REAL10_RESOLVED";
    private const string SessionSettledKey = "M5_REAL10_SETTLED";
    private const string SessionErrorsKey = "M5_REAL10_ERRORS";

    static M5Real10ShotMainSceneCertification_TMP()
    {
        _logPath = Path.GetFullPath("Docs/M5_REAL_10SHOT_CERT_20260919.json");
    ...
    private static void Tick()
    {
        ...
        if (!_started)
        {
            ...
            if (_cue == null || _tracker == null || _ballTracker == null || _lifecycle == null)
            {

...
namespace Meta.XR.BuildingBlocks.Editor
{
    ...
    public class PassthroughCameraAccessBlockData : BlockData
    {
        ...
        {
            var passthroughCameraAccessGameObject = new GameObject($"{Utils.BlockPublicTag} {BlockName}");
            passthroughCameraAccessGameObject.AddComponent<PassthroughCameraAccess>();
            return new List<GameObject> { passthroughCameraAccessGameObject };
        }
